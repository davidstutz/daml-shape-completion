function NFV = qslim(FV,varargin)
...
DEFAULT_INPUT = sprintf('/tmp/qi_%08d.smf',time_ms);
DEFAULT_OUTPUT = sprintf('/tmp/qo_%08d.smf',time_ms);
...
QSLIM = 'libsimplifymesh/qslim/qslim_x86_64';
...
OutputStr(2).arg = DEFAULT_OUTPUT; % default
