...
class Tracklet(object):
  ...
  def get_rotation(self, frame):
    return self.rots[frame - self.get_start_frame()]

  def get_translation(self, frame):
    return self.trans[frame - self.get_start_frame()]

  def get_start_frame(self):
    return self.firstFrame

  def get_end_frame(self):
    return self.firstFrame + self.nFrames
  ...
  def get_object_type_id(self):
    ...
    return object_type_ids[self.objectType]
